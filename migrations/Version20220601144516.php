 ...
 */
final class Version20220601144516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE professeur (id INT AUTO_INCREMENT NOT NULL, r_p_id INT NOT NULL, grade VARCHAR(25) NOT NULL, INDEX IDX_17A55299BF54E9CD (r_p_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
